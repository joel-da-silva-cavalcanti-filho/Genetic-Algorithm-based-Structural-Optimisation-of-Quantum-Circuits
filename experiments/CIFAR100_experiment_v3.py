...
if __name__ == '__main__':
    ...
    input_size = 20
    target_classes = list(range(0,100))
    ...
    CIFAR100_training_dataset = SampledDataset4Training(sampled_training_dataset, target_classes)
    ...
    ansatz_optimization_problem = QuantumCircuitOptimization(n_qubits=n_qubits,
                                                                ...
                                                                n_classes=n_classes,
                                                                mode=mode,
                                                                dataset=CIFAR100_training_dataset,
    ...
    file_path = 'results/resultados_CIFAR100_v2.txt'
    weights_filepath = 'weights/CIFAR100'
