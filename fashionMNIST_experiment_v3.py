...
if __name__ == '__main__':
    ...
    fashionmnist_training_dataset = SampledDataset4Training(sampled_training_dataset, target_classes)
    ...
    ansatz_optimization_problem = QuantumCircuitOptimization(n_qubits=n_qubits,
                                                                ...
                                                                n_classes=n_classes,
                                                                mode=mode,
                                                                dataset=fashionmnist_training_dataset,
    ...
    file_path = 'results/resultados_fashionMNIST_v2.txt'
    weights_filepath = 'weights/fashionMNIST'
